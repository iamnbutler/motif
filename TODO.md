...
_Auto-generated from spool. Do not edit manually._
...
- [ ] Inject debug text (p2)
- [ ] Simulate keyboard events (p2)
- [ ] Screenshot diffing utility (p2)
- [ ] Visual regression test harness (p3)
...
- [ ] Document Metal struct alignment gotcha (p3)
